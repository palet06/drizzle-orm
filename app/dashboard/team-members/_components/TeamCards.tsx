...
import {
  teamMemberSelectType,
  userProjectsSelectType,
} from "@/lib/dbactions/index";
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-5 lg:gap-[7.5]">
        {membersList.length > 0 ? (
          membersList.map((member, index) => (
            <div
              key={index}
              className="flex flex-col shadow-lg bg-white rounded-xl border-[1px]"
            >
              ...
              <div className="flex items-center justify-center border-t-2 ps-[1.875rem] pe-[1.875rem] pt-[1.25rem] pb-[1.25rem] mt-[1.25rem] ">
                <Link
                  href={`team-members/${member.userId}`}
